...
public class WebConstraints {
    ...
    public final static String RESOURCES_PATH = "/src/resources/";
    public final static String ASSETS_PATH = System.getProperty("user.dir")
            + WebConstraints.RESOURCES_PATH + "assets/";
    public final static String PAGES_PATH = "pages";

    public static final String DEFAULT_PAGE = "html/index.html";
